  ...
  terms: {
    ...
    body: (
      <>
        ...
        <p>You may not use the service to deceive, defraud, harass or impersonate any person, to infringe rights, or for any unlawful purpose. The Voice Rights Policy governs uploaded voice models; the Acceptable Use Policy governs conduct. Enforcement includes takedowns, suspensions and cooperation with legal process.</p>
        <H>5. Availability</H>
